...
function hunterRobotFactory.createHunterRobot()
	...
	hunterRobot.nextDestinationX = math.random(properties.BOT_DESTINATION_MIN, properties.BOT_DESTINATION_MAX)
	hunterRobot.nextDestinationY = math.random(properties.BOT_DESTINATION_MIN, properties.BOT_DESTINATION_MAX)
